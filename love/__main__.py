...
PM_START_TEXT = """
Hey....!\n
Welcome I am Queen Amdi 👀\n
A Telegram Group Manager Bot With Cool Modules..
...
buttons = [
    [
        InlineKeyboardButton(
            text="✛ ADD QUEEN AMDI YOUR GROUP ✛", url="t.me/QueenAmdiBot?startgroup=true"),
    ],
    [
    ...
    [
      ...
      InlineKeyboardButton(text="• DEV •", url="https://t.me/Psycho_Bots"),
    ],
    [
        InlineKeyboardButton(
            text="+ GITHUB REPO +", callback_data="source_"),
        InlineKeyboardButton(
            text="- SUPPORT -", url=f"https://t.me/queenamdi"
        ),
    ],
]
...
def Source_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text="""MY SOURCE CODE IS BELOW\n[GitHub Source](https://github.com/King-Amda/Queen-Amdi-Telegram) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=False,
            reply_markup=InlineKeyboardMarkup(
                [
